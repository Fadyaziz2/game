...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v11.4.6"
  WORKING_DIRECTORY "/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/ixwebsocket-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v11.4.6" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v11.4.6")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v11.4.6")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v11.4.6\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/ixwebsocket-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/ixwebsocket-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
