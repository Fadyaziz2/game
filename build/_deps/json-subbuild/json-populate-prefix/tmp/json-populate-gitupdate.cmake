...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v3.11.3"
  WORKING_DIRECTORY "/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/fadygamil/Desktop/c++course/Untitled/game/build/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
